...
The soft-tail hardware and low-dimensional benchmark scripts/data described in the paper were not present in the raw `codebase/` folder, so they are not fabricated here.
